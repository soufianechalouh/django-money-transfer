    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.SET, to='wallet.wallet')),
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.SET, related_name='transfers', to='wallet.wallet')),
            ],
            options={
                'abstract': False,
            },
